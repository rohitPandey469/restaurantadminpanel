    ...
    <footer className="bg-amber-900 text-amber-50">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div>
              ...
              <p className="mt-2 text-sm text-amber-200">Authentic Indian Cuisine</p>
            </div>
            <p className="text-amber-200 text-base leading-6">
              Experience the rich flavors of India with our traditional recipes passed down through generations. 
              From fragrant biryanis to flavorful curries, we bring the authentic taste of India to your table.
            </p>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-amber-200">example@spicekingdom.com</span>
                </li>
        ...
        <div className="mt-12 border-t border-amber-800 pt-8">
          <p className="text-base text-amber-300 text-center">&copy; 2025 Spice Kingdom. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
